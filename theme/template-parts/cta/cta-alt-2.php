...
<section class="cta bg-tertiary bg-center py-2xl-3xl" style="background-image:url(<?php echo get_parent_theme_file_uri("/assets/images/pexels-tiger-lily-4483777.webp") ?>);">
    <div class="wrapper switcher center items-center justify-center text-center text-light" style="--switcher-space: var(--wp--preset--spacing--xl);">
        <div class="stack">
